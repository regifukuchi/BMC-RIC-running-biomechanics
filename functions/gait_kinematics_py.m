function [angles,velocities,jc,R,djc] = gait_kinematics_py(joints,neutral,dynamic,hz,plots)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%  INPUTS
%  --------
%  JOINTS (Python dictionary): Joint centre locations collected as part of the static
%                   trial
%
%  NEUTRAL (Python dictionary): Marker shell positions collected as part of the static
%                   trial.
%
%  DYNAMIC (Python dictionary):    Marker shell positions collected as part of the
...
% convert Python dictionary as Matlab struct
joints  = struct(joints);
neutral = struct(neutral);
